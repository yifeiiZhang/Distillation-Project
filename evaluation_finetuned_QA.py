...
# 文件名留空，你可以根据需求填写文件路径
prompts_file = "file\web_questions_2000_sample.txt"  # 参考答案文件
predictions_file = "file\llama_finetuned_model_predictions.txt"  # 预测文件
...
# 确保参考答案和预测答案数量一致
assert len(reference_answers) == len(predicted_answers), "not match the number of answer"
